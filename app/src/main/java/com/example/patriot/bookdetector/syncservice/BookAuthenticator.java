...
/**
 * Manages "Authentication" to Bookdetector's backend service. The SyncAdapter framework
 ...
 */
public class BookAuthenticator extends AbstractAccountAuthenticator {
    public BookAuthenticator(Context context) {
        super(context);
    }
